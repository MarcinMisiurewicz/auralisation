...
while get(hObject,'Value')==1 && i*chunkLength<=length(sig)-2*chunkLength %jeœli Play jest wciœniête i sygna³ do splotu siê ju¿ nie skoñczy³
    ...
    hAng2=get(handles.hAngSlider,'Value'); %pobranie wartoœci suwaków
    ...
    if hAng2~=hAng1 || vAng2~=vAng1 || v2Ang2~=v2Ang1%obliczenie obróconej bazy HRIR*Y jeœli jakiolwiek suwak zmieni³ po³o¿enie
